...
from validation import freeze_h0_primary_grf_split_v5_qualification as freezer
...
class QualificationFreezerTests(unittest.TestCase):
    def test_payload_freezes_v5_lineage_order_and_closed_authority(self) -> None:
