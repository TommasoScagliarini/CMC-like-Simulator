...
import run_h0_primary_grf_split_v5_full_mean as runner
...
def test_runner_hardcodes_full_mean_fit_and_post_freeze_holdout_order() -> None:
    failure = runner._validate_v4_preexecution_failure()
    assert failure["v4_execution_started"] is False
    assert failure["seed125_semantic_accessed"] is False
