...
from validation import freeze_h0_primary_grf_split_v3_zero_update as freezer
from validation import h0_primary_grf_split_v3_zero_update_contract as contract
from validation import run_h0_primary_grf_split_v3_zero_update_port as driver
...
class ZeroUpdatePortTests(unittest.TestCase):
    def test_contract_is_closed_and_uses_canonical_qualification_evidence(self) -> None:
        self.assertEqual(
            ...
            "PASS_H0_PRIMARY_SPLIT_V3_ZERO_UPDATE_PORT",
        )
    ...
    def _frozen_world(self) -> dict[str, object]:
        ...
        inputs["v3_training_config"].parent.mkdir(parents=True, exist_ok=True)
        inputs["v3_training_config"].write_text("iterations: 1\n", encoding="utf-8")
        ...
        candidate_freeze = {
            ...
            "candidate_id": contract.CANDIDATE_ID,
            "train_seeds": [123, 124, 125],
            "final_holdout_seed": 126,
            "fit": {},
        ...
        _write_json(
            ...
            {
                "status": (
                    "H0_PRIMARY_SPLIT_V3_QUALIFICATION_"
