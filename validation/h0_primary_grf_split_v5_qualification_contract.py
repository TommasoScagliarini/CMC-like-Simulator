"""Immutable contract for post-holdout H0 V5 autonomous qualification.
...
PROTOCOL_ID = "AB06_H0_PRIMARY_GRF_SPLIT_V5_AUTONOMOUS_QUALIFICATION"
CANDIDATE_ID = "H0_primary_split_v5_full_mean"
LOCK_STATUS = "H0_PRIMARY_SPLIT_V5_QUALIFICATION_UNLOCKED"
ROLLOUT_PASS_STATUS = "PASS_H0_PRIMARY_SPLIT_V5_QUALIFICATION_ROLLOUT"
CASE_PASS_STATUS = "PASS_H0_PRIMARY_SPLIT_V5_QUALIFICATION_CASE"
PASS_STATUS = "PASS_H0_PRIMARY_SPLIT_V5_AUTONOMOUS_QUALIFICATION"
FAIL_STATUS = "FAIL_H0_PRIMARY_SPLIT_V5_AUTONOMOUS_QUALIFICATION"
...
RUN_ROOT = V5_RUN_ROOT / "qualification"
...
V5_EXECUTION_LOCK_PATH = PurePosixPath(
    "validation/h0_primary_grf_split_v5_execution_lock.json"
)
V4_PREEXECUTION_FAILURE_PATH = PurePosixPath(
    "validation/h0_primary_grf_split_v4_preexecution_failure.json"
)
V5_EXECUTION_LEDGER_PATH = V5_RUN_ROOT / "execution_ledger.json"
HOLDOUT_RECEIPT_PATH = V5_RUN_ROOT / "holdout" / "receipt.json"
HOLDOUT_GATE_PATH = V5_RUN_ROOT / "holdout" / "gate.json"
CANDIDATE_FREEZE_PATH = V5_RUN_ROOT / "adaptation" / "candidate_freeze.json"
CANDIDATE_MODULE_PATH = (
    V5_RUN_ROOT / "adaptation" / "rl_module_target_adapted"
)
...
# Explicitly accepted before any qualification execution.  V5 changes the
...
__all__ = [
    ...
    "SOURCE_PROTOCOL_ID",
    "V5_EXECUTION_LEDGER_PATH",
    "V5_EXECUTION_LOCK_PATH",
    "V4_PREEXECUTION_FAILURE_PATH",
    "ZERO_REQUIRED_COUNTS",
    "canonical_cases",
    "gate_destination",
    "rollout_destination",
