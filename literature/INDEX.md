# INDE — "opensim + rl" paper corpus

Router for the knowledge base. PDFs live on the Desktop (not in the repo):
`/Users/tommy/Desktop/report opensim+rl/` → abbreviated `@/` below (see
**PDF locations** appendix). Usage protocol: [README_FOR_LLM.md](README_FOR_LLM.md).
...
## Appendix — PDF locations (`@/` = `/Users/tommy/Desktop/report opensim+rl/`)
