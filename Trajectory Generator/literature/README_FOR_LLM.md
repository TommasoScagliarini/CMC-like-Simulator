...
## What it is
A structured, hyperlinked extraction of the papers collected under the corpus
root (macOS: `/Users/tommy/Desktop/report opensim+rl/`; Windows:
`C:\Users\tomma\Desktop\report opensim+rl\`) — two deep-research efforts, folders
...
keywords: [k1, k2]
pdf: "<absolute macOS path to the PDF>"
pdf_win: "<absolute Windows path to the same PDF>"
pages_read: "1-7 (full)"
...
- PDFs are NOT copied here: they stay on the Desktop. Notes keep both paths:
  `pdf:` (macOS) and `pdf_win:` (Windows), same corpus on both machines.
