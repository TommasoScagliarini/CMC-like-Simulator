"""V26C J20 - the zero-iteration restore audit that closes gate G9.
...
resolved rev1's normalisation contradiction) and rev3 (which fixed the token
counts, the wrapper's containment wording and the GO status rule, and tightened
R9 to require the evidence rev1 had promised). All four are pinned by the GO and
re-hashed here; precedence is rev3 > rev2 > rev1 > base. The gate count is 13.
...
PREREG_PRECEDENCE = ("rev3", "rev2", "rev1", "base")
GO_REQUIRED_STATUS = "APPROVED"
RUNNER_NAME = "v26c_j20_restore_audit.py"
TEST_NAME = "test_v26c_j20_restore_audit.py"
...
# ------------------------------------------------------------------- the leaf --
LEAF_ROOT = "j20_runs"
LEAF_NAME = "j20_restore_audit_v26c_2026-08-27_r1"
