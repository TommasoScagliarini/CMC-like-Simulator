"""Source-only contract for the V12R9/Q3 full checkpoint-zero port.

The namespace is additive and binds only public, stable V12R9 and V12R9-Q3
...
for _root in (_LOCAL_VALIDATION / "v12r9", _LOCAL_VALIDATION / "v12r9q3"):
...
SCHEMA_VERSION = 1294
REVISION = "2026-08-14"
PROTOCOL_ID = "AB06_H0_V12R9_Q3_ZERO_CHECKPOINT_W512_V26"
PIPELINE_ID = "H0_V12R9_Q3_FRESH_CRITIC_ZERO_PROGRESS_PORT"
SOURCE_STATE = "SOURCE_CLOSED_RUNTIME_DEFERRED_UNTIL_R9_AND_Q3_TERMINAL_PASS"
REQUIRED_WORKING_DIRECTORY = "repository_root"

ROOT = PurePosixPath("Trajectory Generator/baseline_MLP/validation/v12r9zero")
LOCK_PATH = ROOT / "h0_v12r9_zero_checkpoint_execution_lock.json"
OUTPUT_ROOT = ROOT / "h0_v12r9_zero_checkpoint_run_20260814"
...
LOCK_STATUS = "PASS_H0_V12R9_ZERO_CHECKPOINT_EXECUTION_LOCK"
PASS_STATUS = "PASS_H0_V12R9_Q3_ZERO_CHECKPOINT"
FAIL_STATUS = "FAIL_H0_V12R9_Q3_ZERO_CHECKPOINT"
HANDOFF_STATUS = "DEFERRED_H0_V12R9_ZERO_CHECKPOINT_RESUME_INTERFACE"
NEXT_STAGE_AFTER_ZERO_PASS = "WAIT_SEPARATE_V12R9MORPH_POSITIVE_AB"
ATTEMPT_STATUS = "H0_V12R9_ZERO_CHECKPOINT_ATTEMPT_CLAIMED"
OUTPUT_NAMES = {
...
R9_TERMINAL_ENDPOINT = {
    ...
    "required_next_stage": "WAIT_SEPARATE_V12R9Q3_PROTOCOL",
}
R9_CANDIDATE_FREEZE_ENDPOINT = {
...
Q3_TERMINAL_ENDPOINT = {
    ...
    "expected_critic_updates": 0,
    "expected_ppo_updates": 0,
    "required_next_stage": q3.NEXT_STAGE_AFTER_Q3_PASS,
}
Q3_FINAL_ENDPOINT = {
...
CANDIDATE_BINDING_STATE = "DEFERRED_UNTIL_R9_AND_Q3_TERMINAL_PASS"
CANDIDATE_ID = None
...
SOURCE_TOPOLOGY_ID = r9.TOPOLOGY_ID
...
INPUT_RELATIVE_PATHS = {
    "r9_protocol_freeze": r9.PROTOCOL_FREEZE_PATH.as_posix(),
    "r9_execution_lock": r9.EXECUTION_LOCK_PATH.as_posix(),
    "r9_candidate_freeze": r9.CANDIDATE_FREEZE_PATH.as_posix(),
    "r9_final_development": r9.FINAL_DEVELOPMENT_PATH.as_posix(),
...
SOURCE_RELATIVE_PATHS = {
    ...
    "contract": (ROOT / "h0_v12r9_zero_checkpoint_contract.py").as_posix(),
    "gates": (ROOT / "h0_v12r9_zero_checkpoint_gates.py").as_posix(),
    "freezer": (ROOT / "freeze_h0_v12r9_zero_checkpoint.py").as_posix(),
    "runner": (ROOT / "run_h0_v12r9_zero_checkpoint.py").as_posix(),
    "tests": (ROOT / "test_h0_v12r9_zero_checkpoint.py").as_posix(),
    ...
    "q3_gates": (q3.ROOT / "h0_v12r9_q3_qualification_gates.py").as_posix(),
...
REQUIRED_AUDIT_CHECKS = (
    ...
    "repository_root_working_directory_pinned",
...
AUTHORITY = {
    ...
    "freeze_requires_r9_terminal_pass": True,
    ...
    "resume_command_requires_repository_root_cwd": True,
...
def candidate_id_for_tree(tree_sha256: str) -> str:
    """Use the exact stable V12R9 candidate identity function."""
...
def contract_self_check() -> dict[str, Any]:
    ...
    checks = {
        "exact_upstream_abi": R9_TERMINAL_ENDPOINT["protocol_id"] == r9.PROTOCOL_ID
        and R9_TERMINAL_ENDPOINT["path"] == r9.LEDGER_PATH.as_posix()
        ...
        and CANDIDATE_BINDING_STATE == "DEFERRED_UNTIL_R9_AND_Q3_TERMINAL_PASS",
        ...
        is False,
        "repository_root_cwd_pinned": REQUIRED_WORKING_DIRECTORY == "repository_root"
        and AUTHORITY["resume_command_requires_repository_root_cwd"] is True,
    }
