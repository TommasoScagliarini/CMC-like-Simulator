"""Pure, independent, fail-closed gates for the V12R7-Q3 scaffold."""
...
try:
    ...
    from . import h0_v12r7_q3_prerequisites as prerequisites
    ...
    import h0_v12r7_q3_prerequisites as prerequisites
...
def morphology_zero_ab_gate(payload: Any) -> dict[str, Any]:
    ...
    return {
        "schema_version": contract.SCHEMA_VERSION,
        "status": "PASS_H0_V12R7_Q3_MORPHOLOGY_ZERO_AB"
        if passed
        else "FAIL_H0_V12R7_Q3_MORPHOLOGY_ZERO_AB",
        "passed": passed,
        "checks": checks,
    }
...
def v26_event_gate(payload: Any) -> dict[str, Any]:
    ...
    return {
        "schema_version": contract.SCHEMA_VERSION,
        "status": "PASS_H0_V12R7_Q3_V26_EVENT_GATE"
        if passed
        else "FAIL_H0_V12R7_Q3_V26_EVENT_GATE",
        "passed": passed,
        "checks": checks,
    }
...
def common_rollout_gate(summary: Any, *, role: str, case_id: str) -> dict[str, Any]:
    ...
    except (ValueError, prerequisites.V12R7Q3PrerequisiteError):
        return _failure(contract.ROLLOUT_FAIL_STATUS, "r7_candidate_bound")
...
def aggregate_qualification_gate(summary: Any) -> dict[str, Any]:
    ...
    try:
        binding = prerequisites.current_candidate_binding()
    except prerequisites.V12R7Q3PrerequisiteError:
        return _failure(contract.AGGREGATE_FAIL_STATUS, "r7_candidate_bound")
    data = _mapping(summary)
