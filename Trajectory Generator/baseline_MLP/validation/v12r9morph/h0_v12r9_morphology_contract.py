"""Immutable contract for the latent-live V12R9 positive morphology A/B.

Importing this module is inert.  The protocol can be frozen only after the
native R9, R9-Q3, and R9-zero semantic verifiers all return terminal PASS for
...
for _root in (
    _VALIDATION_ROOT / "v12r9",
    _VALIDATION_ROOT / "v12r9q3",
    _VALIDATION_ROOT / "v12r9zero",
):
    if str(_root) not in sys.path:
        sys.path.insert(0, str(_root))

import h0_v12r9_q3_qualification_contract as q3  # noqa: E402
import h0_v12r9_recovery_contract as r9  # noqa: E402
import h0_v12r9_zero_checkpoint_contract as zero  # noqa: E402


SCHEMA_VERSION = 1295
REVISION = "2026-08-14"
PROTOCOL_ID = "AB06_H0_V12R9_MORPH_POSITIVE_0025_QUALIFICATION"
PIPELINE_ID = "H0_V12R9_MORPH_SIX_CASE_CAUSAL_PHYSICAL_AB"
SOURCE_STATE = "SOURCE_CLOSED_RUNTIME_DEFERRED_UNTIL_R9_Q3_ZERO_TERMINAL_PASS"
REQUIRED_WORKING_DIRECTORY = "repository_root"

ROOT = PurePosixPath("Trajectory Generator/baseline_MLP/validation/v12r9morph")
RUN_ROOT = ROOT / "h0_v12r9_morph_run_20260814"
PAIR_ROOT = RUN_ROOT / "pairs"
FINAL_ROOT = RUN_ROOT / "finalize"
PROTOCOL_FREEZE_PATH = ROOT / "h0_v12r9_morph_protocol_freeze.json"
EXECUTION_LOCK_PATH = ROOT / "h0_v12r9_morph_execution_lock.json"
...
FREEZE_STATUS = "PASS_H0_V12R9_MORPH_PROTOCOL_FREEZE"
LOCK_STATUS = "PASS_H0_V12R9_MORPH_EXECUTION_LOCK"
CLAIM_STATUS = "CLAIM_H0_V12R9_MORPH_PIPELINE"
ARM_COMPLETE_STATUS = "COMPLETE_H0_V12R9_MORPH_ARM"
ARM_PASS_STATUS = "PASS_H0_V12R9_MORPH_ARM"
PAIR_COMPLETE_STATUS = "COMPLETE_H0_V12R9_MORPH_PAIR"
PAIR_PASS_STATUS = "PASS_H0_V12R9_MORPH_PAIR"
PAIR_FAIL_STATUS = "FAIL_H0_V12R9_MORPH_PAIR"
AGGREGATE_PASS_STATUS = "PASS_H0_V12R9_MORPH_POSITIVE_QUALIFICATION"
AGGREGATE_FAIL_STATUS = "FAIL_H0_V12R9_MORPH_POSITIVE_QUALIFICATION"
PIPELINE_TERMINAL_PASS_STATUS = "PASS_H0_V12R9_MORPH_PIPELINE_TERMINAL"
PIPELINE_TERMINAL_FAIL_STATUS = "FAIL_H0_V12R9_MORPH_PIPELINE_TERMINAL"
HANDOFF_PASS_STATUS = "PASS_H0_V12R9_MORPH_TRAINING_HANDOFF"
...
R9_TERMINAL_ENDPOINT = {
    "schema_version": r9.SCHEMA_VERSION,
    "protocol_id": r9.PROTOCOL_ID,
    "pipeline_id": r9.PIPELINE_ID,
    "path": r9.LEDGER_PATH.as_posix(),
    "required_status": r9.PIPELINE_TERMINAL_PASS_STATUS,
    "verifier_module": (r9.ROOT / "run_h0_v12r9_recovery.py").as_posix(),
...
Q3_TERMINAL_ENDPOINT = {
    ...
    "verifier_module": (
        q3.ROOT / "runtime/run_h0_v12r9_q3_qualification.py"
    ).as_posix(),
    "verifier": "verify_terminal_ledger",
...
ZERO_TERMINAL_ENDPOINT = {
    ...
    "verifier_module": (zero.ROOT / "run_h0_v12r9_zero_checkpoint.py").as_posix(),
...
UPSTREAM_ENDPOINTS = {
    "v12r9_terminal": R9_TERMINAL_ENDPOINT,
    "v12r9_q3_terminal": Q3_TERMINAL_ENDPOINT,
    "v12r9_zero_terminal": ZERO_TERMINAL_ENDPOINT,
}

CANDIDATE_MODULE_PATH = r9.CANDIDATE_MODULE_PATH
...
SOURCE_RELATIVE_PATHS = {
    ...
    "contract": (ROOT / "h0_v12r9_morphology_contract.py").as_posix(),
    "gates": (ROOT / "h0_v12r9_morphology_gates.py").as_posix(),
    "freezer": (ROOT / "freeze_h0_v12r9_morphology.py").as_posix(),
    "physical_runtime": (ROOT / "h0_v12r9_morphology_physical_rollout.py").as_posix(),
    "causal_runtime": (ROOT / "h0_v12r9_morphology_causal_runtime.py").as_posix(),
    "training_launcher": (ROOT / "run_h0_v12r9_morphology_training.py").as_posix(),
    "training_site_hook": (ROOT / "sitecustomize.py").as_posix(),
    "readiness_auditor": (ROOT / "audit_h0_v12r9_morphology_readiness.py").as_posix(),
    "runner": (ROOT / "run_h0_v12r9_morphology.py").as_posix(),
    "tests": (ROOT / "test_h0_v12r9_morphology_scaffold.py").as_posix(),
    "r9_contract": (r9.ROOT / "h0_v12r9_recovery_contract.py").as_posix(),
    "r9_runner": R9_TERMINAL_ENDPOINT["verifier_module"],
    "q3_contract": (q3.ROOT / "h0_v12r9_q3_qualification_contract.py").as_posix(),
    "q3_runner": Q3_TERMINAL_ENDPOINT["verifier_module"],
    "q3_physical": (q3.ROOT / "runtime/h0_v12r9_q3_physical_rollout.py").as_posix(),
    "q3_noise": (q3.ROOT / "runtime/prepare_h0_v12r9_q3_noise_tapes.py").as_posix(),
    "mature_physical": (
        "Trajectory Generator/baseline_MLP/validation/v12r5q3/runtime/"
        "h0_v12r5_q3_physical_rollout.py"
    ),
    "zero_contract": (zero.ROOT / "h0_v12r9_zero_checkpoint_contract.py").as_posix(),
    "zero_gates": (zero.ROOT / "h0_v12r9_zero_checkpoint_gates.py").as_posix(),
...
INPUT_RELATIVE_PATHS = {
    "r9_terminal_ledger": r9.LEDGER_PATH.as_posix(),
...
CAUSAL_RUNTIME_ID = "h0_v12r9_morph_strict_terminal_delay_v1"
CAUSAL_RUNTIME_CONFIG = {
    "runtime_id": CAUSAL_RUNTIME_ID,
    "implementation": (ROOT / "h0_v12r9_morphology_causal_runtime.py").as_posix(),
    "training_launcher": (ROOT / "run_h0_v12r9_morphology_training.py").as_posix(),
...
TRAINING_ENTRYPOINT = ROOT / "run_h0_v12r9_morphology_training.py"
FINAL_OUTPUT_DIR = zero.FINAL_TRAINING_OUTPUT
TRAINING_VALIDATION_ENDPOINT = {
    "namespace_root": ("Trajectory Generator/baseline_MLP/validation/v12r9training"),
    ...
    "expected_new_updates": FINAL_TRAINING_ITERATIONS,
...
AUTHORITY = {
    ...
    "repository_root_working_directory_required": True,
    "training_preflight_required": True,
    "postrun_integrity_audit_required": True,
}


def candidate_id_for_tree(tree_sha256: str) -> str:
    return r9.candidate_id(tree_sha256)
...
def final_training_argv(platform_id: str) -> tuple[str, ...]:
    ...
    if (
        ...
        or json.loads(argv[argv.index("--reward-json") + 1]) != POSITIVE_REWARD_CONFIG
    ):
...
def contract_self_check() -> dict[str, Any]:
    ...
    checks = {
        "native_endpoints": R9_TERMINAL_ENDPOINT["protocol_id"] == r9.PROTOCOL_ID
        ...
        "frozen_corridor": FROZEN_CORRIDOR_SHA256
        == "258700b5da99aa9110a92039834bf4061ca81b9eb7ea770b93919a0b3105e801",
        "repository_root_cwd": REQUIRED_WORKING_DIRECTORY == "repository_root"
        and AUTHORITY["repository_root_working_directory_required"] is True,
        "training_validation": TRAINING_VALIDATION_ENDPOINT["expected_new_updates"]
        == FINAL_TRAINING_ITERATIONS
        == 50
        and TRAINING_VALIDATION_ENDPOINT["preflight_required_before_training"] is True
        and TRAINING_VALIDATION_ENDPOINT["postrun_audit_required"] is True
        and AUTHORITY["training_preflight_required"] is True
        and AUTHORITY["postrun_integrity_audit_required"] is True,
        "resume_only": all(
