...
import h0_v12r13_masked_teacher_fitter as fitter  # noqa: E402
import run_h0_v12r13_masked_teacher_fit as runner  # noqa: E402
...
def test_high_fidelity_gates_match_review_contract() -> None:
    ...
    assert fitter.PER_CASE_ACTION_RMSE_LIMIT == 5.5e-3
    assert fitter.PER_TRAJECTORY_ACTION_RMSE_LIMIT == 5.5e-3
...
def test_real_save_reload_and_fresh_critic_transplant_without_fit(
    ...
    with pytest.raises(fitter.V12R13MaskedTeacherFitError, match="no-clobber"):
...
def test_p1_journals_independently_reconstruct_supervision_and_transitions(
    ...
    fitter._write_json_exclusive(  # noqa: SLF001
        ...
        {
            "passed": True,
            "status": "PASS_H0_V12R13_P1_CANDIDATE_EXPOSED_COLLECTION",
            "trajectory_id": trajectory_id,
    ...
    with pytest.raises(fitter.V12R13MaskedTeacherFitError, match="artifact record"):
...
def test_p1_npz_rejects_each_reconstructed_journal_field_drift(
    ...
    with pytest.raises(
        fitter.V12R13MaskedTeacherFitError,
...
def test_governance_freeze_and_lock_are_exact_and_no_clobber(
    ...
    with pytest.raises(fitter.V12R13MaskedTeacherFitError, match="freeze"):
...
def test_execute_is_blocked_before_loading_without_frozen_governance(
    ...
    with pytest.raises(fitter.V12R13MaskedTeacherFitError, match="strict JSON"):
...
def test_p1_real_builders_roundtrip_through_p2_loader(
    ...
    import h0_v12r13_tape_dagger as p1_contract  # noqa: PLC0415
    import run_h0_v12r13_tape_dagger as p1_runner  # noqa: PLC0415
