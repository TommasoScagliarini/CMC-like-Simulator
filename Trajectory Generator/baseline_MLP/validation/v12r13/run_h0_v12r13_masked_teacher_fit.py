"""CLI for the no-clobber V12R13 masked safe-teacher actor builder."""
...
EXECUTION_ACKNOWLEDGEMENT = "V12R13_ONE_SHOT_FIXED_FIT"
GOVERNANCE_ACKNOWLEDGEMENT = "V12R13_FREEZE_REVIEWED_SOURCES"


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Inspect, preflight, or execute the one-shot V12R13 invariant-18D "
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        if args.describe:
            ...
            if args.acknowledge_governance != GOVERNANCE_ACKNOWLEDGEMENT:
                raise fitter.V12R13MaskedTeacherFitError(
    ...
    except fitter.V12R13MaskedTeacherFitError as exc:
        print(
            json.dumps(
                {
                    "status": "FAIL_H0_V12R13_MASKED_SAFE_TEACHER_CLI",
                    "passed": False,
