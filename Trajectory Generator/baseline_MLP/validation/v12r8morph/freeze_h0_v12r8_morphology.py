"""Live exclusive freezer for the V12R8 morphology physical A/B.
...
def verify_protocol_freeze_payload(
    ...
    *,
    ...
    checks = {
        ...
        "checkpoint_module": _same_json(module.get("checkpoint"), binding.get("checkpoint"))
