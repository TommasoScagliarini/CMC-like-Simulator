"""Execution-free independent Q3 contract for the future V12R9 candidate.

The contract intentionally remains candidate- and artifact-deferred.  It fixes
the six held-out conditions, baseline-first ordering, exact standard actor
...
if str(_LOCAL_VALIDATION / "v12r9") not in sys.path:
    sys.path.insert(0, str(_LOCAL_VALIDATION / "v12r9"))
...
SCHEMA_VERSION = 1293
REVISION = "2026-08-14"
PROTOCOL_ID = "AB06_H0_V12R9_Q3_V26_MORPHOLOGY_ZERO_QUALIFICATION"
PIPELINE_ID = "H0_V12R9_Q3_BASELINE_FIRST_SIX_CASE_PAIRED"
LINEAGE_STATE = "DEFERRED_UNTIL_R9_TERMINAL_PASS"
...
ROOT = PurePosixPath("Trajectory Generator/baseline_MLP/validation/v12r9q3")
RUN_ROOT = ROOT / "h0_v12r9_q3_run_20260814"
NOISE_ROOT = ROOT / "h0_v12r9_q3_noise_tapes"
BASELINE_ROOT = RUN_ROOT / "baseline"
CANDIDATE_ROOT = RUN_ROOT / "candidate"
PAIR_ROOT = RUN_ROOT / "pairs"
FINAL_ROOT = RUN_ROOT / "finalize"
PROTOCOL_FREEZE_PATH = ROOT / "h0_v12r9_q3_qualification_protocol_freeze.json"
EXECUTION_LOCK_PATH = ROOT / "h0_v12r9_q3_qualification_execution_lock.json"
...
PREREQUISITE_PASS_STATUS = "PASS_H0_V12R9_Q3_R9_PREREQUISITES"
PREREQUISITE_FAIL_STATUS = "FAIL_H0_V12R9_Q3_R9_PREREQUISITES"
ROLLOUT_COMPLETE_STATUS = "COMPLETE_H0_V12R9_Q3_QUALIFICATION_ROLLOUT"
ROLLOUT_PASS_STATUS = "PASS_H0_V12R9_Q3_QUALIFICATION_ROLLOUT"
ROLLOUT_FAIL_STATUS = "FAIL_H0_V12R9_Q3_QUALIFICATION_ROLLOUT"
PAIR_PASS_STATUS = "PASS_H0_V12R9_Q3_QUALIFICATION_PAIR"
PAIR_FAIL_STATUS = "FAIL_H0_V12R9_Q3_QUALIFICATION_PAIR"
AGGREGATE_COMPLETE_STATUS = "COMPLETE_H0_V12R9_Q3_QUALIFICATION"
AGGREGATE_PASS_STATUS = "PASS_H0_V12R9_Q3_INDEPENDENT_QUALIFICATION"
AGGREGATE_FAIL_STATUS = "FAIL_H0_V12R9_Q3_INDEPENDENT_QUALIFICATION"
PIPELINE_TERMINAL_PASS_STATUS = "PASS_H0_V12R9_Q3_PIPELINE_TERMINAL"
NEXT_STAGE_AFTER_Q3_PASS = "WAIT_SEPARATE_CHECKPOINT_ZERO_PROTOCOL"

CANDIDATE_BINDING_STATE = "DEFERRED_UNTIL_R9_TERMINAL_PASS"
CANDIDATE_ID = None
CANDIDATE_MODULE = None
CANDIDATE_MODULE_PATH = r9.CANDIDATE_MODULE_PATH
CANDIDATE_SELECTION_RULE = r9.CANDIDATE_SELECTION_RULE
...
PREREQUISITE_REQUIREMENTS = (
    {
        "name": "r9_protocol_freeze",
        "path": r9.PROTOCOL_FREEZE_PATH.as_posix(),
        "required_status": r9.PROTOCOL_FREEZE_PASS_STATUS,
        "semantic_verifier": "verify_protocol_freeze",
        "candidate_required": False,
    },
    {
        "name": "r9_execution_lock",
        "path": r9.EXECUTION_LOCK_PATH.as_posix(),
        "required_status": r9.EXECUTION_LOCK_PASS_STATUS,
        "semantic_verifier": "verify_execution_lock",
        "candidate_required": False,
    },
    {
        "name": "r9_candidate_freeze_receipt",
        "path": r9.CANDIDATE_FREEZE_PATH.as_posix(),
        "required_status": r9.CANDIDATE_FREEZE_PASS_STATUS,
        "semantic_verifier": "verify_candidate_freeze_receipt",
        "candidate_required": True,
    },
    {
        "name": "r9_final_development_receipt",
        "path": r9.FINAL_DEVELOPMENT_PATH.as_posix(),
        "required_status": r9.DEVELOPMENT_PASS_STATUS,
        "semantic_verifier": "verify_final_development_receipt",
        "candidate_required": True,
    },
    {
        "name": "r9_terminal_pass_ledger",
...
QUALIFICATION_SOURCE_PATHS = {
    ...
    "q3_artifacts": (ROOT / "h0_v12r9_q3_artifacts.py").as_posix(),
    "q3_contract": (ROOT / "h0_v12r9_q3_qualification_contract.py").as_posix(),
    "q3_prerequisites": (ROOT / "h0_v12r9_q3_prerequisites.py").as_posix(),
    "q3_gates": (ROOT / "h0_v12r9_q3_qualification_gates.py").as_posix(),
    "q3_tests": (ROOT / "test_h0_v12r9_q3_source_scaffold.py").as_posix(),
    "q3_real_tree_abi_tests": (ROOT / "test_h0_v12r9_q3_real_tree_abi.py").as_posix(),
    "q3_runtime_package": (ROOT / "runtime/__init__.py").as_posix(),
    "r9_contract": (r9.ROOT / "h0_v12r9_recovery_contract.py").as_posix(),
    "r9_protocol_freezer": (r9.ROOT / "freeze_h0_v12r9_recovery.py").as_posix(),
    "r9_runner": (r9.ROOT / "run_h0_v12r9_recovery.py").as_posix(),
    "r9_prefix_adjudicator": (r9.ROOT / "h0_v12r9_prefix_adjudicator.py").as_posix(),
    "r9_recovery_probe": (r9.ROOT / "h0_v12r9_recovery_probe.py").as_posix(),
    "r9_recovery_fitter": (r9.ROOT / "h0_v12r9_recovery_fitter.py").as_posix(),
...
DEFERRED_RUNTIME_SOURCE_PATHS = {
    "q3_protocol_freezer": (
        ROOT / "runtime/freeze_h0_v12r9_q3_qualification_protocol.py"
    ).as_posix(),
    "q3_noise_preparer": (
        ROOT / "runtime/prepare_h0_v12r9_q3_noise_tapes.py"
    ).as_posix(),
    "q3_physical_rollout": (
        ROOT / "runtime/h0_v12r9_q3_physical_rollout.py"
    ).as_posix(),
    "q3_runner": (ROOT / "runtime/run_h0_v12r9_q3_qualification.py").as_posix(),
    "q3_runtime_tests": (ROOT / "runtime/test_h0_v12r9_q3_runtime.py").as_posix(),
}
...
def canonical_case(case_id: str) -> dict[str, Any]:
    ...
    raise ValueError(f"unknown V12R9-Q3 case: {case_id!r}")


def canonical_rollout(role: str, case_id: str) -> dict[str, Any]:
    if role not in ROLE_ORDER:
        raise ValueError(f"unknown V12R9-Q3 role: {role!r}")
...
def contract_self_check() -> dict[str, Any]:
    checks = {
        ...
        "r9_binding_exact": CANDIDATE_MODULE_PATH == r9.CANDIDATE_MODULE_PATH
        and CANDIDATE_SELECTION_RULE == r9.CANDIDATE_SELECTION_RULE
        ...
        "independent_holdout_disjoint_from_r9": set(CASE_IDS).isdisjoint(
            r9.COLLECTION_CASE_IDS
        )
        and set(CASE_IDS).isdisjoint(r9.DEVELOPMENT_CASE_IDS)
        and STOCHASTIC_SEEDS == (130, 131, 132, 133)
        and set(STOCHASTIC_SEEDS).isdisjoint({126, 127, 128})
        and tuple(case["case_id"] for case in HOLDOUT_CASES) == CASE_IDS,
        ...
        "r9_terminal_pass_deferred": LINEAGE_STATE == "DEFERRED_UNTIL_R9_TERMINAL_PASS",
    }
    return {
        "status": "PASS_H0_V12R9_Q3_SOURCE_CONTRACT"
        if all(checks.values())
        else "FAIL_H0_V12R9_Q3_SOURCE_CONTRACT",
